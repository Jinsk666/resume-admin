...
var filters1 = {
	mime_types: [ //允许上传图片和zip,rar文件以及视频文件
		{
			title: "Image files",
			//extensions: "jpg,jpeg,gif,png,bmp,zip,rar,txt,doc,docx,xls,xlsx",
...
function callback() {
	$(window.parent.document).find("#loading_box").hide();
	console.log(uploaded_file_url);
	window.oss_upload = uploaded_file_url;
	window.oss_upload_name = uploaded_file_name;
};
accessid = '';
accesskey = '';
host = '';
...
function send_request(obj, entId) {
	...
	if(xmlhttp != null) {
		serverUrl = domain_url + '/testUpload?type=' + obj + '&id=' + entId;
